...
<p class="body-text-s important-text-bg">**Tip:** Save your practice script in a separate directory (i.e. not inside your app directory) -- I typically save mine to something like `~/scratch/practice_script.R`.</p>
