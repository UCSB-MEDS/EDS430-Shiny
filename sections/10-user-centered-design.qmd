...
<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} have a checklist of considerations to reference each time you build an app</p>

. . . 

<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} have a few additional resources to dive deeper into UX/UI design</p>
