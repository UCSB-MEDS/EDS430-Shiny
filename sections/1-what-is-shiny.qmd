...
<p class="small-text topbr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` a two-file shiny app with two reactive plots (a scatterplot and a histogram) -- we'll also learn how to use layout functions to create a more visually-pleasing (and organized) UI. -- [`r fontawesome::fa("github", fill = "#05859B", a11y = "sem")` source code](https://github.com/samanthacsik/EDS430-shiny-app/tree/main/two-file-app)</p>
