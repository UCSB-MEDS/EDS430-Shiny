...
<p class="custom-subtitle bottombr">`r fontawesome::fa("code", fill = "#d2e3f3", a11y = "sem")` Writing functions</p>
...
<div class="slide-title-smaller">Create a function to builds our scatterplot</div>
