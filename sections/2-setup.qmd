...
<p class="small-text topbr">**1.** In your project repo, create a subdirectory to house your app -- I'm calling mine, `single-file-app`.</p>

. . . 

<p class="small-text">**2.** Create a new R script inside `/single-file-app` and name it `app.R` -- you **must** name your script `app.R`. Copy/type the following code into `app.R`, or use the `shinyapp` [snippet](https://rstudio.github.io/rstudio-extensions/rstudio_snippets.html) to automatically generate a shiny app template.<p>
