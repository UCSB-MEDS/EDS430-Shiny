...
<p class="body-text">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` try creating a **rough sketch** of your intended layout *before* hitting the keyboard (think of this as UI layout pseudocode!)</p>
