...
::: {.column width="45%"}
<p class="small-text">**(a)** user-friendly validation error messages that appear when all data are deselected using widgets</p>
...
<p class="small-text">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` Despite having **two** inputs, we only need **one** validation test for our Penguins plot.</p> 
