...
<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} motivation for building the app</p>
<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} brief instructions for exploring the data</p>
<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} who maintains the app, where the code lives, how to submit issues/suggestions</p>
:::
