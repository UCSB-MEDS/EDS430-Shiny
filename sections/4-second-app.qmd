...
<p class="small-text">First, let's build a UI that has a navigation bar with two tabs -- one for background information and one to contain our plots.</p>

<p class="small-text">**Tip:** It can be *super* helpful add code comments at the start and end of each UI element -- for example, see `# data viz tabPanel---` and `# END data viz tabPanel`, below. Adding text that you will eventually replace with content (e.g. plots, tables, images, longer text) may help to visualize what you're working towards as well.</p>
```{r}
#| eval: false
#| echo: true
ui <- fluidPage(
...
<div class="slide-title-smaller">Add three tabs (one for each plot we'll be creating) to the "Explore the data" page</div>

<p class="small-text">Give your tabs the following titles: `Crab`, `Trout`, and `Bison`.</p>

```{r}
#| eval: false
#| echo: true
#| code-line-numbers: "18-39"
ui <- fluidPage(
    ...
    tabPanel(title = "Explore the data",
      ...
      tabsetPanel(
        ...
        tabPanel(title = "Crab",
                 ...
                 "crab data viz here", # REPLACE THIS WITH CONTENT
        ...
        tabPanel(title = "Bison",
                 ...
                 "bison data viz here"  # REPLACE THIS WITH CONTENT
...
<div class="slide-title-smaller">Create sidebar & main panel areas for crab plot inputs & outputs</div>

<p class="small-text">Let's add a sidebar and main panel to the `Crab` tab -- we'll eventually place our input in the sidebar and output in the main panel.</p>

```{r}
#| eval: false
#| echo: true
#| code-line-numbers: "23-40"
ui <- fluidPage(
...
<div class="slide-title-smaller">`r fontawesome::fa("question", fill = "#05859B", a11y = "sem")` Exercise 2: Add sidebar and main panels to the `Trout` and `Bison` tabs</div>
...
<br>
<br>
<p class="body-text">I encourage you to type these out yourself, rather than copy/paste! And be sure to add text where your inputs/outputs will eventually be placed. When you're done, you app should look like this:</p>
:::
...
<div class="slide-title-smaller">`r fontawesome::fa("check", fill = "#05859B", a11y = "sem")` Exercise 2: A solution</div>

```{r}
#| eval: false
#| echo: true
#| code-line-numbers: "46-63|69-86"
ui <- fluidPage(
