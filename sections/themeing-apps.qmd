...
<p class="body-text topbr">There are also a couple ways to apply your finished theme to your app, but we'll use the method of generating a `.css` file, then calling those styles into our app.</p>
...
<p class="small-text">**Note:** I found [this vignette](https://cran.r-project.org/web/packages/fresh/vignettes/fresh.html) helpful for understanding how to apply your themes.</p>
...
<center><p class="body-text topbr">**Let's practice writing Sass & CSS for our ____ app**</p></center>
