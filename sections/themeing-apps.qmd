...
<p class="small-text">`r fontawesome::fa("check", fill = "#05859B", a11y = "sem")` allows you to fine-tune your app's styling</p>
:::
...
<center><p class="smaller-text topbr">**Sass** (**S**yntactically **A**wesome **S**tyle**s**heets) is a CSS extension language and CSS preprocessor -- meaning Sass needs to be converted to CSS before it can be interpreted by your web browser.</p></center> 
:::
...
<p class="smaller-text">Build a stylesheet (a `.css` file) inside your app's `www/` directory and load your file into your app's header (for shinydashboards, include your header inside `dashboardBody()`. **This is the most ideal approach** -- it allows for style reuse, caching, and keeps styling contained in one spot.</p>
