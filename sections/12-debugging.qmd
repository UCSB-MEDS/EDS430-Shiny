...
<p class="body-text-s">Read about the components of the [status bar](https://rstudio.github.io/reactlog/articles/reactlog.html#status-bar) and the meaning of different [reactive states](https://rstudio.github.io/reactlog/articles/reactlog.html#reactive-states) in the `reactlog` vignette.</p>
...
<p class="body-text-s">But we call `penguins_text` when rendering our output in the **server**:</p>
