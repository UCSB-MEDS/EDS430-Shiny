...
<p class="small-text">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} Add titles to each box</p>
<p class="small-text topbr">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} Create a `/text` folder within your app's directory and add three markdown (`.md`) files. Write/format text for the background info (left), data citation (top-right), and disclaimer (bottom-right) boxes. Example text below:</p>
...
<p class="small-text topbr">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} Titles can include icons! For example: `title = tagList(icon("icon-name"), strong("title text here"))`</p>
