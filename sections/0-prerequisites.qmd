...
<div class="body-text topbr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` You have downloaded the data</div>  

<center><div class="large-body-text topbr">No prior Shiny experience is necessary!</div></center>
