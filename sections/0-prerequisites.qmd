...
<div class="body-text topbr">[{{< fa angle-right title="a bullet point" >}}]{.teal-text} You have the required R packages installed. You can install/update them all at once by running:</div>
...
<center><div class="body-text-xl teal-text">No prior Shiny experience necessary!</div></center>
