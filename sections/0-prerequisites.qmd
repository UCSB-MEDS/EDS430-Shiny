...
::: {.column width="70%"}
<div class="body-text topbr bottombr">*This workshop assumes that participants have the following:*</div>
...
<div class="body-text topbr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` The required R packages installed. You can install/update them all at once by running:</div>
...
```
<div class="body-text topbr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` You have downloaded the _____ data</div>  

<div class="body-text topbr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` No prior Shiny experience is necessary!</div>

---

## {#resources1 data-menu-title="Resources"}

<div class="slide-title bottombr">There are *lots* of really great Shiny resources out there</div>

<p class="body-text topbr">This workshop draws on many great online resources, including:</p>
...
<p class="body-text topbr">Be sure to check out Posit/RStudio's great instructional resources and examples as well:</p>
