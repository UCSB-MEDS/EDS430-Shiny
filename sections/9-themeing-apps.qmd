...
<p class="small-text">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` a basic understanding of how to apply CSS & Sass styling to your app</p>
...
<p class="small-text">`r fontawesome::fa("check", fill = "#05859B", a11y = "sem")` `{bslib}` does more than just themeing! Check out the [December 2022 announcement](https://shiny.rstudio.com/blog/announcing-new-r-shiny-ui-components.html) of new UI components made possible with the latest package release</p>
:::
